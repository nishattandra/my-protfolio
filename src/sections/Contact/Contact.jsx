    ...
    return (
        <div className='mb-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
                <div className='md:w-1/2 md:mt-24 ml-6 md:ml-20'>
                    <div className='flex'>
                        <SlLocationPin className='min-w-[3.5rem] min-h-[3.5rem] text-blue-400 mb-4'></SlLocationPin>
                        <span className='text-white font-bold text-2xl ml-4 md:ml-8 mt-3'>SHH,JUST </span>
                    </div>
                    <div className='flex'>
                        <FcCallback className='min-w-[3.5rem] min-h-[3.5rem] mb-4'></FcCallback>
                        <span className='text-white font-bold text-2xl ml-4 md:ml-8 mt-3'>+8801521546406 </span>
                    </div>
                    <div className='flex'>
                        <BsWhatsapp className='min-w-[3.5rem] min-h-[3.5rem] mb-4 text-blue-400'></BsWhatsapp>
                        <span className='text-white font-bold text-2xl ml-4 md:ml-8 mt-3'>+8801613915286 </span>
                    </div>
                    <div className='flex'>
                        <FiMail className='min-w-[3.5rem] min-h-[3.5rem] mb-4 text-blue-400'></FiMail>
                        <span className='text-white font-semibold md:font-bold  text-2xl ml-2 md:ml-8 mt-4'>nishattandra2001@gmail.com </span>
                    </div>
                ...
                <div className='md:w-1/2 mt-20 fromborder border-2 border-gradient-to-r from-indigo-500 via-purple-500 to-pink-500'>
