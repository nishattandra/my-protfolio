        ...
        <div >
            ...
            <div className='md:flex md:flex-row-reverse'>
                ...
                <div className='text-white mt-10  md:ml-36 md:w-1/2 m-3 ' data-aos="zoom-in-down">
                    ...
                    <br />
                    <Link to='/skills'>
                        <button className=" btn bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 border-0 text-white font-bold mt-4 mb-10">My SKills <FaArrowAltCircleRight></FaArrowAltCircleRight></button>
                    </Link>
                </div>
            </div>
